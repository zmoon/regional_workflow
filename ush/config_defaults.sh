...
PPN_ADD_AQM_ICS="1"
PPN_ADD_AQM_LBCS="24"
PPN_RUN_NEXUS=""  # will be calculated from NCORES_PER_NODE and OMP_NUM_THREADS in setup.sh
#
# Walltimes.
#
...
KMP_AFFINITY_RUN_NEXUS="scatter"
OMP_NUM_THREADS_RUN_NEXUS="2"
OMP_STACKSIZE_RUN_NEXUS="1024m"
#
#-----------------------------------------------------------------------
#
