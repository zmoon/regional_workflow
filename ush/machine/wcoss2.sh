...
function file_location() {
  ...
  case ${external_model} in
    ...
    "FV3GFS")
      location='/lfs/h1/ops/prod/com/gfs/v16.2/gfs.${YYYYMMDD}/${HH}/atmos'
      ;;
    "RAP")
      location='/lfs/h1/ops/prod/com/rap/v5.1'
      ;;
    "HRRR")
      location='/lfs/h1/ops/prod/com/hrrr/v4.1'
      ;;
    "NAM")
      location='/lfs/h1/ops/prod/com/nam/v4.2'
      ;;
...
staged_data_dir="/lfs/h2/emc/lam/noscrub/UFS_SRW_App/develop"
...
RUN_CMD_UTILS="mpiexec"
RUN_CMD_FCST='mpiexec -n ${PE_MEMBER01}'
RUN_CMD_POST="mpiexec"

# MET/METplus-Related Paths
MET_INSTALL_DIR=${MET_INSTALL_DIR:-"/apps/ops/para/libs/intel/19.1.3.304/met/10.0.1"}
METPLUS_PATH=${METPLUS_PATH:-"/apps/ops/para/libs/intel/19.1.3.304/metplus/4.0.0"}
